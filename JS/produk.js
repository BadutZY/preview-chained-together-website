...
const productData = {
    premium: {
        ...
        features: [
            "Material: Logam berkualitas tinggi dengan lapisan chrome",
            "Dimensi: 5cm x 3cm",
            "Berat: 25 gram",
            "Tahan air dan anti karat",
            "Packaging: Box premium dengan sertifikat keaslian"
        ],
        images: [
            "IMG/logo2.png",
            "IMG/SeconLogo.png",
    ...
    custom: {
        title: "Custom Design",
        price: "Rp 65.000",
        description: "Wujudkan keychain impian Anda dengan layanan custom design eksklusif. Dari logo perusahaan, nama pribadi, hingga desain artistik, semuanya bisa diwujudkan dengan detail sempurna menggunakan teknologi laser engraving terdepan.",
        features: [
            "Material: Pilihan logam premium atau acrylic berkualitas",
            "Dimensi: Disesuaikan dengan desain (max 8cm)",
            "Teknologi: Laser engraving precision",
            "Konsultasi desain gratis dengan designer",
...
// ============================================
// REMOVED: Hover effect untuk product images
// Biarkan CSS yang handle hover untuk smooth transition
// ============================================
// KODE INI DIHAPUS KARENA KONFLIK DENGAN CSS HOVER
